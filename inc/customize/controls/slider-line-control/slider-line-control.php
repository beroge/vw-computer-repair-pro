<?php
	 ...
	 *
	 *  */
	class Vw_Computer_Repair_Pro_Slider_Custom_Control extends WP_Customize_Control {
		/**
	...
	function vw_computer_repair_pro_slider_line_script() {
	...
	add_action( 'customize_controls_enqueue_scripts', 'vw_computer_repair_pro_slider_line_script' );
?>