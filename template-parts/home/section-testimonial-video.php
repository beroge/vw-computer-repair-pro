          ...
          <div class="video text-center" style="<?php echo esc_attr($hide_testimonial); ?>">
            <?php if(get_theme_mod('vw_computer_repair_pro_video_play_icon')!=''){ ?>
              <a data-toggle="modal" href="#myModal" id="myBtn">
                <i class="fas fa-play wow pulse delay-2000 animated animate animated animated animated" data-wow-duration="1s" data-wow-iteration="infinate" style="visibility: visible; animation-duration: 1s; animation-iteration-count: infinite"></i>
            ...
            <div id="myNewModal" class="modal-new">
              ...
              <div class="modal-contents">
                  ...
                  <?php if( get_theme_mod('vw_computer_repair_pro_video_url') != ''){ ?>
                    <iframe width="400px" height="400px" src=" <?php echo (get_theme_mod('vw_computer_repair_pro_video_url')); ?>">
                  </iframe>
                <?php }else{ ?>
