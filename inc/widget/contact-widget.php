...
class wpb_widget extends WP_Widget {
	function __construct() {
		...
		// Base ID of your widget
			...
			__('Contct Us', 'vw-computer-repair-pro'), 
			// Widget description
			array( 'description' => __( 'Widget for About Us section', 'vw-computer-repair-pro' ), ) 
		);
	}
...
// This is where the action happens
	public function widget( $args, $instance ) {
			...
			<?php if($location != ''){ ?>
				<table width="100%">
					<tr>
						...
						<td>
						<p class="contact-text"><?php echo esc_textarea($location); ?></p></td>
					</tr>
				</table>
			<?php } ?>
		</p>
			...
			<?php if($email != ''){ ?>
				<table width="100%">
					<tr>
						...
						<td>
						<p class="contact-text"><?php echo esc_html($email); ?></p></td>
					</tr>
				</table>	
			<?php } ?>		
		</p>
			...
			<?php if($phone != ''){ ?>
				<table width="100%">
					<tr>
						...
						<td>
						<p class="contact-text phone-text"><?php echo esc_html($phone); ?></p></td>
					</tr>
				</table>
			<?php } ?>
		</p>
		...
		//echo __( 'Hello, World!', 'vw-computer-repair-pro' );
	...
	public function form( $instance ) {
		...
		if ( isset( $instance[ 'custom_title' ] ) ) {
			...
			esc_html($custom_title = __( 'New title', 'vw-computer-repair-pro' ));
		}		
		//custom_content
		if ( isset( $instance[ 'custom_content' ] ) ) {
			...
			esc_html($custom_content = __( 'Custom Content', 'vw-computer-repair-pro' ));
		}
		//Location
		if ( isset( $instance[ 'location' ] ) ) {
			...
			esc_html($location = __( 'Location', 'vw-computer-repair-pro' ));
		}
		//Phone
		if ( isset( $instance[ 'phone' ] ) ) {
			...
			esc_html($phone = __( 'Phone', 'vw-computer-repair-pro' ));
		}
		//Email
		if ( isset( $instance[ 'email' ] ) ) {
			...
			esc_html($email = __( 'Email', 'vw-computer-repair-pro' ));
		}	
		...
		if ( isset( $instance[ 'time' ] ) ) {
			...
			esc_html($time = __( 'Time', 'vw-computer-repair-pro' ));
		}		

		?>
			<!--Main title field -->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'custom_title' )); ?>"><?php esc_html_e( 'Title:', 'vw-computer-repair-pro' ); ?></label> 
			...
			<!--Message field -->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'custom_content' )); ?>"><?php esc_html_e( 'Content:','vw-computer-repair-pro' ); ?></label> 
			...
			<!--Location field-->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'location' )); ?>"><?php esc_html_e( 'Location:', 'vw-computer-repair-pro'); ?></label> 
			...
			<!--Phone field-->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'phone' )); ?>"><?php esc_html_e( 'Phone:', 'vw-computer-repair-pro'); ?></label> 
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'phone' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'phone' )); ?>" type="text" value="<?php echo esc_attr( $phone ); ?>" />
			</p>
			<!--Email field -->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'email' )); ?>"><?php esc_html_e( 'Email:', 'vw-computer-repair-pro'); ?></label> 
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'email' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'email' )); ?>" type="text" value="<?php echo esc_attr( $email ); ?>" />
			</p>
			<!-- Time  -->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'time' )); ?>"><?php esc_html_e( 'Time:', 'vw-computer-repair-pro'); ?></label> 
